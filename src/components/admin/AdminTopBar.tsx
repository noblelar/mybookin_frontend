  ...
  return (
    <header className="h-14 bg-white border-b border-slate-200 flex items-center px-6 gap-4 flex-shrink-0">
      ...
      <div className="flex items-center gap-2 ml-auto">
        ...
        {/* Settings gear */}
        <button className="w-9 h-9 flex items-center justify-center rounded-md hover:bg-slate-100 transition-colors text-slate-500">
        ...
        <div className="flex items-center gap-2.5 pl-1">
          <div className="text-right hidden sm:block">
            <div className="text-sm font-bold text-[#0B1C30] leading-tight">Alexander Vance</div>
            <div className="text-[10px] text-slate-400 uppercase tracking-wide">Platform Superuser</div>
          </div>
