    ...
    <header className="sticky top-0 z-50 w-full bg-white/90 backdrop-blur-md border-b border-slate-200/60 shadow-sm">
      <div className="max-w-[1280px] mx-auto px-4 md:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <Link href="/" className="flex-shrink-0">
          <span className="font-black text-[#0F172A] tracking-tight uppercase text-lg leading-none">
            MyBookins
          </span>
        </Link>
        ...
        {/* Search Bar */}
        <div className="flex-1 max-w-xs lg:max-w-sm hidden sm:flex items-center gap-2 bg-slate-100 rounded-lg px-3 py-2 border border-slate-200">
          <svg width="16" height="16" viewBox="0 0 26 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 opacity-50">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <button className="w-9 h-9 flex items-center justify-center rounded-full hover:bg-slate-100 transition-colors">
            <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0 17V15H2V8C2 6.61667 2.41667 5.38750 3.25 4.3125C4.08333 3.23750 5.16667 2.53333 6.5 2.2V1.5C6.5 1.08333 6.64583 0.729167 6.9375 0.4375C7.22917 0.145833 7.58333 0 8 0C8.41667 0 8.77083 0.145833 9.0625 0.4375C9.35417 0.729167 9.5 1.08333 9.5 1.5V2.2C10.8333 2.53333 11.9167 3.23750 12.75 4.3125C13.5833 5.38750 14 6.61667 14 8V15H16V17H0ZM8 20C7.45 20 6.97917 19.8042 6.5875 19.4125C6.19583 19.0208 6 18.55 6 18H10C10 18.55 9.80417 19.0208 9.4125 19.4125C9.02083 19.8042 8.55 20 8 20ZM4 15H12V8C12 6.9 11.6083 5.95833 10.825 5.175C10.0417 4.39167 9.1 4 8 4C6.9 4 5.95833 4.39167 5.175 5.175C4.39167 5.95833 4 6.9 4 8V15Z" fill="#64748B"/>
            </svg>
          </button>
