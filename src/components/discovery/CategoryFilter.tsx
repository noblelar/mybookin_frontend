...
const categories = [
  ...
  {
    label: 'Tutor', mobileLabel: 'Tutor',
    icon: (
      <svg width="14" height="12" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg" className="hidden md:block">
        <path d="M8.25 13.5L3 10.65V6.15L0 4.5L8.25 0L16.5 4.5V10.5H15V5.325L13.5 6.15V10.65L8.25 13.5Z" fill="currentColor"/>
      </svg>
    ),
  },
]
    ...
    <div className="border-b border-[rgba(198,198,205,0.2)] bg-white md:bg-[#F8F9FF]">
      <div className="max-w-[1280px] mx-auto px-4 md:px-6 py-3 overflow-x-auto scrollbar-hide">
        <div className="flex items-center gap-2 min-w-max">
          {categories.map(({ label, mobileLabel, icon }) => {
