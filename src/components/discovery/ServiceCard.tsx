    ...
    <div className="bg-white border border-[rgba(198,198,205,0.15)] shadow-sm overflow-hidden group hover:shadow-md transition-shadow duration-200 cursor-pointer">
      ...
      <div className="relative h-[195px] overflow-hidden">
        ...
        <button
          ...
          className="absolute top-3 right-3 w-8 h-8 bg-white/90 backdrop-blur-sm flex items-center justify-center rounded-full shadow-sm hover:bg-white transition-colors"
      ...
      <div className="px-4 pt-3 pb-4 flex flex-col gap-1.5">
        ...
        <div className="flex items-start justify-between gap-2">
          <h3 className="font-bold text-[#0B1C30] text-sm leading-snug font-['Manrope',sans-serif] flex-1">
            {name}
          </h3>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[#45464D] text-xs font-medium">{distance}</span>
        </div>
      </div>
    </div>
  )
